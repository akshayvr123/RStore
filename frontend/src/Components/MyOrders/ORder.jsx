                    ...
                    <div className="main-box border border-gray-200 rounded-xl pt-6 max-w-xl max-lg:mx-auto lg:max-w-full">
                        <div
                            ...
                            <div className="data">
                                ...
                                <p className="font-semibold text-base leading-7 text-black mt-4">Payment Status: <span className="text-gray-400 font-medium"> Success</span></p>
                            </div>
                            <button
                                className="rounded-full py-3 px-7 font-semibold text-sm leading-7 text-white bg-green-600 max-lg:mt-5 shadow-sm shadow-transparent transition-all duration-500 hover:bg-green-700 hover:shadow-indigo-400">Track
                                Your Order</button>
                        </div>
                                    ...
                                    <div className="w-full px-3 min-[400px]:px-6">
                                        <div className="flex flex-col lg:flex-row items-center py-6 border-b border-gray-200 gap-6 w-full">
                                            <div className="img-box max-lg:w-full">
                                                <img src={item.image} alt="Premium Watch image" className="aspect-square w-full lg:max-w-[140px]"></img>
                                            ...
                                            <div className="flex flex-row items-center w-full ">
                                                <div className="grid grid-cols-1 lg:grid-cols-2 w-full">
                                                    <div className="flex items-center">
                                                        <div className="">
                                                            <h2 className="font-semibold text-xl leading-8 text-black mb-0">
                                                                {item.name}</h2>
                                                            ...
                                                            <div className="flex items-center ">
                                                                <p
                                                                    ...
                                                                    Size: <span className="text-gray-500">{item.quantity}</span></p>
                                                    ...
                                                    <div className="grid grid-cols-5">
                                                        <div className="col-span-5 lg:col-span-1 flex items-center max-lg:mt-3">
                                                            <div className="flex gap-3 lg:block">
                                                                ...
                                                                <p className="lg:mt-4 font-medium text-sm leading-7 text-indigo-600">₹{item.price*item.count}</p>
                                                            </div>
                                                        </div>
                        ...
                        <div className="w-full border-t border-gray-200 px-6 flex flex-col lg:flex-row items-center justify-between ">
                            ...
                            <p className="font-semibold text-lg text-black py-6">Total Price: <span className="text-indigo-600"> ₹{total+49}</span></p>
                        </div>

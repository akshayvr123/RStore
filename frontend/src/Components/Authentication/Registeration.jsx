...
const Registeration = () => {
    ...
    return (
        <section 
            ...
            style={{ backgroundImage: "url('https://img.freepik.com/premium-photo/background-image-featuring-paper-bag-filled-with-healthy-vegan-vegetarian-food-including_176841-12510.jpg')", backgroundSize: 'cover', backgroundPosition: 'center' }}
        >
